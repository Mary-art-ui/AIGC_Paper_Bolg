...
下面按你要的 **3 个任务**来讲（针对你上传的《Evaluation of Retrieval-Augmented Generation: A Survey》arXiv:2405.07437v2）。我会重点围绕论文提出的 **统一评测流程 Auepora**、以及 **Fig.1（RAG结构与可评对）/ Fig.2（Target模块）/ Table 1-2（框架&数据集）**来组织内容。
